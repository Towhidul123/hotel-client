        ...
        <div className="flex flex-col md:flex-row ">
          <Link className="flex" to='/'>
            <div className=" flex justify-center">
              <img src="https://i.ibb.co/74Vn506/hotel.png" alt="logo-ct" className="w-12" />
            </div>
            <h2 className="font-cust font-semibold text-xs md:font-bold md:text-xl flex items-center justify-center">BoBo Motel </h2>
